...
public class NotificationViewModel extends ViewModel {
    ...
    public void refreshBadgeManually() {
        badgeLiveData.setValue(repository.getChatBadgeCount().getValue());
    }
